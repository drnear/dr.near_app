angular.module('DrNEAR.controllers', ['ngCordova','DrNEAR.services'])
    ...
    .controller( 'LoginCtrl', function( $scope, $state, $rootScope, $timeout, $ionicPopup, $cordovaFacebook, User, Session, AUTH_EVENTS ) {
        ...
        ctrl.fbLogin = function(){        
          ...
          if(!(ionic.Platform.isIOS() || ionic.Platform.isAndroid())){         
            Parse.FacebookUtils.logIn(null, {
              ...
              error: function(user, error) {
                console.log( 'DrNEAR fb login error: ' + error.message);
                $timeout( function(){
                    $rootScope.$broadcast(AUTH_EVENTS.loginFailed);
                });                
              }
          ...
          //Native Login
            ...
            $cordovaFacebook.login(["public_profile", "email"]).then(function(success){
              ...
              console.log("DrNEAR fb login " + success);
              ...
              Parse.FacebookUtils.logIn(facebookAuthData, {
                ...
                error: function(user, error) {
                  console.log( 'DrNEAR Parse fb login error: ' + error.message);
                  $timeout( function(){
                    $rootScope.$broadcast(AUTH_EVENTS.loginFailed);
                  });
                }
              ...
              console.log("DrNEAR fb login error " + error[0]);
            });
